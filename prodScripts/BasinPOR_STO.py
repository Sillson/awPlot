...
import warnings
import time
from lib.awdbToolsJson import dataUrl, trimToOct1, padMissingData, getBasinSites, calcSMSAvg, fillMissingData
...
#            numDays = max(len(l) for l in plotData.values())
        ...
        layout = go.Layout(
            ...
            yaxis=dict(title=r'Avg. Temperature (&#176;F)', hoverformat=".1f",
                       tickformat="0f"),
            xaxis=dict(
                range=sliderDates,
                tickformat="%b %e",
